    ...
    <body class="bg" background="./imgs/collage/collage.png">
        ...
        <div class="outbox outpos">
            <div class="inbox inpos">
                <form method="POST" action="addmovie_be.php"> 
                    <!-- enctype="multipart/form-data"> -->
                    <!-- why this not working????? -->
                    <b class="text">Movie details :</b> <br>
                    <input class="inputfields" type="text" name="title" id="" placeholder="Title" required> <br> 
                    <input class="inputfields" type="text" name="genre" id="" placeholder="Genre" required> <br>
                    <input class="inputfields" type="float" name="rating" id="" placeholder="Ratings" required> <br> 

                    <b class="text">Add a thumbnail :</b>
                    <input class="filebutton" type="file" name="pic" id="" accept="image/*" required> 

                    <b class="text">Add a video :</b>
                    <input class="filebutton" type="file" name="vid" id="" accept="video/*" required> 

                    <input class="signinbutton" type="submit" name="Add Movie"> 
                </form>
            </div>
        </div>
    </body>
